...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	СуммаПродажи = ПозицияПродажи.Итог("Сумма");
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ПродажаБилетаПозицияПродажи.Номенклатура.ВидАттракциона КАК ВидАттракциона,
		|	ПродажаБилетаПозицияПродажи.Номенклатура КАК Номенклатура,
		|	ПродажаБилетаПозицияПродажи.Номенклатура.КоличествоПосещений * ПродажаБилетаПозицияПродажи.Количество КАК
		|		КоличествоПосещений,
		|	ПродажаБилетаПозицияПродажи.Сумма
		|ИЗ
		|	Документ.ПродажаБилета.ПозицияПродажи КАК ПродажаБилетаПозицияПродажи
		|ГДЕ
		|	ПродажаБилетаПозицияПродажи.Ссылка = &Ссылка";
