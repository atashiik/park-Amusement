...
Процедура СформироватьПосещенияПосетителя(Посетитель, ДатаПосещения, СписокАттракционов, ГСЧ)
...
Функция КупитьБилет(Посетитель, Аттракцион, ДатаПосещения, ГСЧ)
	...
	СтрокаТЧ = ДокОбъект.ПозицияПродажи.Добавить();
	...
	ДокОбъект.СуммаДокумента = ДокОбъект.ПозицияПродажи.Итог("Сумма");
